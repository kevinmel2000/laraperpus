...
class AuthorsController extends Controller
{
    ...
    public function index( Request $request, Builder $htmlBuilder )
    {
        ...
        // Generate DataTable dengan htmlbuilder datatable
        $html = $htmlBuilder
    ...
    {
        // Validasi input dan create penulis sesuai dengan field di Author Model
    ...
    public function update( Request $request, $id )
    {
        ...
        //get author id
        $author = Author::find( $id );
        //Update author berdasarkan id dengan field name saja
