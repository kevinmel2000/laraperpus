...
class BooksController extends Controller
{
    ...
    public function index( Request $request, Builder $htmlBuilder )
    {
        ...
        // generate htmlbuilder datatables
        $html = $htmlBuilder
                ->addColumn( [ 'data' => 'title', 'name' => 'title', 'title' => 'Judul' ] )
                ->addColumn( [ 'data' => 'amount', 'name' => 'amount', 'title' => 'Jumlah', 'class' => 'text-center' ] )
    ...
    public function store( StoreBookRequest $request ) {
        ...
        // mengambil semua input kecuali cover cover punya logic tersendiri
        ...
        if( $request->hasFile( 'cover' ) ) {
            ...
            // buat nama file random berikut extensinya
    ...
    /**
     * Fungsi untuk menghapus cover lama
     *
     * @param
     * @return
     */
    public function hapus_cover( $cover ) {
    ...
    public function update( UpdateBookRequest $request, $id )
    {
        ...
        if( $request->hasFile( 'cover' ) ) {
            ...
            // membuat nama file random beserta ekstensinya
            $filename = md5( time() ) . '.' . $extension;
            $destinationPath = public_path() . DIRECTORY_SEPARATOR . 'img';
            ...
            // ganti cover yg lama dengan yg baru
            $book->cover = $filename;
            $book->save();
        }
    ...
    // method untuk pinjam buku bagi member
